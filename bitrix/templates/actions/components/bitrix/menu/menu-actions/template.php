...
<ul class="left-menu" id="entr">
	<li class="<?if($_SERVER["REQUEST_URI"] === "/actions/"){?>active11<?}?>"><a href="/actions/" class="flevel <?if($_SERVER["REQUEST_URI"] === "/actions/"){?>active<?}?>">Мероприятия</a></li>
	<li class="<?if($_SERVER["REQUEST_URI"] === "/actions/master-class/"){?>active11<?}?>"><a href="/actions/master-class/" class="flevel <?if($_SERVER["REQUEST_URI"] === "/actions/master-class/"){?>active<?}?>">Мастер-классы</a></li>
</ul>
<?$t= count($arResult);?>
<?$j=0;?>
