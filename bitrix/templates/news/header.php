...
<script type="text/javascript">
	$(function(){
		AjaxContent.init({containerDiv:"#teachers",contentDiv:"#teachers"}).ajaxify_links(".filter li a");
	});
  ...
  $("#searchform").animate({width:"100%"},500 );
        ...
        <div id="search">
         ...
         <div style=" width: 100%; text-align: center;  margin-top: -5px; margin-bottom: 5px;">
                    <a href="mailto:ippk_sales@pfur.ru" style="font-size: 13px;  font-weight: 600; color: #293f80;">ippk_sales@pfur.ru </span>
          </div>
