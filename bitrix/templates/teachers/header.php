  ...
  $("#searchform").animate({width:"100%"},500 );
        ...
        <div id="search">
         ...
         <div style=" width: 100%; text-align: center;  margin-top: -5px; margin-bottom: 5px;">
          ...
          <br/>
<a href="/onlinerequest/" data-reveal-id="subscribetop_reveal" onclick="yaCounter38926455.reachGoal('zayavka');" id="subscribetop" style="margin-top: -20px;">ЗАЯВКА НА ОБУЧЕНИЕ</a>
        </div>
