...
<li class="<?if($_SERVER["REQUEST_URI"] === "/employment/"){?>active11<?}?>"><a href="/employment/" class="flevel <?if($_SERVER["REQUEST_URI"] === "/employment/"){?>active<?}?>">Практика и трудоустройство</a>
<ul>
<?$t= count($arResult);?>
<?$j=0;?>
<?
