...
<style type="text/css">
.left {margin:0px 20px 40px 30px; }
.right {margin:0px 40px 40px 0;}
</style>
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter16198597 = new Ya.Metrika({id:16198597,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<div style="
    ...
    margin-top: -5px;
    margin-bottom: 5px;
"><a href="mailto:ippk_sales@pfur.ru" style="
    font-size: 13px;
    font-weight: 600;
    color: #293f80;
">ippk_sales@pfur.ru</a></div>
          <br/>
<a href="/onlinerequest/" data-reveal-id="subscribetop_reveal" id="subscribetop" onclick="yaCounter38926455.reachGoal('zayavka');" style="margin-top: -20px;">ЗАЯВКА НА ОБУЧЕНИЕ</a>  
        </div>
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	...
	<div id="content">
        ...
        <div id="centr">
<div class="left">	
<? $APPLICATION->IncludeComponent("custom:curses.left.menu", ".default", array(),false,array("ACTIVE_COMPONENT" => "Y"));?>
<? $APPLICATION->IncludeComponent("custom:similar.programms", ".default", array(),false,array("ACTIVE_COMPONENT" => "Y"));?> 
</div>
