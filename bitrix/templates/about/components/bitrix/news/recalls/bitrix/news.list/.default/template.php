<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div class="news-content" id="<?=$this->GetEditAreaId($arItem['ID']);?>" style="margin-bottom:10px; width:650px; clear:both;">
		...
		<?if($arItem["PREVIEW_TEXT"]):?>
			<div class="news-prevtext" style="width:650px;"><?echo $arItem["PREVIEW_TEXT"];?></div>
		<?endif;?>
