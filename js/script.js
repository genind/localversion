...
Cufon('.news_part .news_zag, .raspisanie .raspisanie_header, .naprav .naprav_header', { fontFamily: 'PFBeauSansPro', hover: true });
Cufon('.left .tree li a.l1', { fontFamily: 'PFBeauSansPro', hover: true });
Cufon('.left .sub_tree li a', { fontFamily: 'PFBeauSansPro', hover: true });
...
Cufon('#entr li a.flevel', { fontFamily: 'PFBeauSansPro', hover: true });
Cufon('.fltr li a.year', { fontFamily: 'PFBeauSansPro', hover: true });
jQuery(document).ready(function(){
	...
	$("a[rel^='help']").prettyPhoto({
							...
							markup: '<div class="pp_pic_holder" style=""> \
										...
										<a class="pp_close"  href="#" style="top:10px;">Close</a> \
																</div> \
															</div> \
														\
												</div> \
