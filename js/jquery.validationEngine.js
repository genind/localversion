...
(function($) {
	...
	if($.validationEngineLanguage){				// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
						...
						"alertTextCheckboxMultiple":"* Поле обязательно для заполнения",
						"alertTextCheckboxe":"* Поле обязательно для заполнения"},
					"length":{
						"regex":"none",
						"alertText":"*Между ",
						"alertText2":" и ",
					...
					"email":{
						...
						"alertText":"* Неправильный e-mail адрес"},	
					"date":{
                         "regex":"/^[0-9]{4}\-\[0-9]{1,2}\-\[0-9]{1,2}$/",
                         "alertText":"* Неправильный формат даты, должно быть в YYYY-MM-DD формате"},
					"onlyNumber":{
						"regex":"/^[0-9\ ]+$/",
						"alertText":"* Только числа"},	
					"noSpecialCaracters":{
						"regex":"/^[0-9a-zA-Z]+$/",
						"alertText":"* Не разрешены специальные символы"},	
					"ajaxUser":{
						"file":"validateUser.php",
						"alertTextOk":"* This user is available",	
						"alertTextLoad":"* Идет загрузка, пожалуйста подождите",
...
$.validationEngine = {
	...
	buildPrompt : function(caller,promptText,type,ajaxed) {			// ERROR PROMPT CREATION AND DISPLAY WHEN AN ERROR OCCUR
		...
		/* POSITIONNING */
		if($.validationEngine.settings.promptPosition == "topRight"){callerleftPosition +=  callerWidth -30; /*callerTopPosition += -inputHeight +50;*/ }
		...
		if($.validationEngine.settings.promptPosition == "bottomLeft"){
			...
			callerTopPosition = callerTopPosition + callerHeight + 5;
		}
		if($.validationEngine.settings.promptPosition == "bottomRight"){
			callerHeight =  $(caller).height();
			callerleftPosition +=  callerWidth -30;
			callerTopPosition +=  callerHeight + 25;
		}
		$(divFormError).css({
	...
	updatePromptText : function(caller,promptText,type,ajaxed) {	// UPDATE TEXT ERROR IF AN ERROR IS ALREADY DISPLAYED
		...
		if($.validationEngine.settings.promptPosition == "centerRight"){  callerleftPosition +=  callerWidth +13; callerTopPosition =  callerTopPosition + callerHeight + 15}
		if($.validationEngine.settings.promptPosition == "topLeft" || $.validationEngine.settings.promptPosition == "topRight"){
			//callerTopPosition = callerTopPosition  -inputHeight +50
		}
