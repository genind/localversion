...
(function($) {
    $.fn.jCarouselLite = function(o) {
        ...
        return this.each(function() {
            ...
            var j = Math.floor((o.vertical ? c.height() : c.width())/v);
            f.outerWidth(j);
            f.css({margin:"0px",overflow:"hidden",float:o.vertical ? "none" : "left"});
            c.css("visibility", "visible");
            ul.css({margin:"0",padding:"0",position:"relative","list-style-type":"none","z-index":"1"});
			c.css({width:j*v,overflow:"hidden",position:"relative","z-index":"2",left:"0px"});
            var g = o.vertical ? height(f) : width(f);
            var h = g * itemLength;
            
            f.css({width:f.width(),height:c.height()});
